...
int pieceValues[6] = {S(114, 84), S(455, 318), S(458, 304), S(656, 523), S(1263, 1135), S(5000, 5000)};
...
int bishopMobilityBonus[14] = {S(-25, -42), S(-11, -18), S(9, -6), S(17, 7), S(20, 14), S(22, 20), S(26, 24), S(27, 28), S(34, 36), S(35, 37), S(43, 47), S(48, 49), S(55, 56), S(58, 60)};
int rookMobilityBonus[15] =   {S(-29, -45), S(-11, -20), S(-5, 4), S(0, 10), S(2, 11), S(5, 15), S(8, 16), S(10, 18), S(11, 19), S(17, 25), S(24, 35), S(26, 42), S(28, 48), S(30, 52), S(42, 62)};
