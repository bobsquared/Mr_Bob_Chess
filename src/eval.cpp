...
int knightMobilityBonus[9] =  {S(-41, -70), S(-23, -20), S(-8, 8), S(-9, 18), S(-1, 13), S(6, 16), S(12, 18), S(12, 24), S(37, 11)};
int bishopMobilityBonus[14] = {S(-36, -18), S(-26, -10), S(-4, 2), S(4, 16), S(16, 18), S(22, 28), S(26, 32), S(26, 34), S(28, 38), S(32, 30), S(49, 26), S(88, 18), S(71, 36), S(94, 20)};
int rookMobilityBonus[15] =   {S(-110, -67), S(-20, -42), S(-12, 0), S(-10, 17), S(-6, 20), S(-4, 28), S(-1, 36), S(8, 34), S(18, 37), S(30, 37), S(34, 42), S(44, 44), S(46, 47), S(54, 44), S(75, 35)};
int queenMobilityBonus[27] =  {S(0, -178), S(0, -31), S(0, -35), S(0, -27), S(0, -21), S(0, -20), S(0, -10), S(0, -7), S(0, 0),
                          S(0, 0), S(0, 0), S(0, 6), S(0, 12), S(0, 15), S(0, 17), S(0, 32), S(0, 34), S(0, 43), S(0, 66),
                          S(0, 88), S(0, 89), S(0, 95), S(0, 114), S(0, 127), S(0, 141), S(0, 143), S(0, 157)};
