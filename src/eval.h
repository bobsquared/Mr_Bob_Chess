...
private:
    ...
    // Mobility
    const int knightMobilityBonus[9] =  {S(-35, -35), S(-25, -25), S(-8, -8), -S(4, 4), S(5, 5), S(8, 8), S(12, 12), S(18, 18), S(25, 25)};
    const int bishopMobilityBonus[14] = {S(-25, -25), S(-15, -15), S(8, 8), S(12, 12), S(16, 16), S(18, 18), S(20, 20), S(25, 25), S(32, 32), S(40, 40), S(45, 45), S(47, 47), S(52, 52), S(57, 57)};
    const int rookMobilityBonus[15] =   {S(-32, -32), S(-15, -15), S(1, 1), S(4, 4), S(5, 5), S(8, 8), S(12, 12), S(14, 14), S(15, 15), S(21, 21), S(27, 27), S(30, 30), S(34, 34), S(36, 36), S(42, 42)};
    const int queenMobilityBonus[27] =  {S(-15, -15), S(-15, -15), S(-10, -10), S(-5, -5), S(12, 12), S(12, 12), S(15, 15), S(16, 16), S(18, 18),
                                         S(21, 21), S(26, 26), S(29, 29), S(35, 35), S(35, 35), S(37, 37), S(37, 37), S(42, 42), S(42, 42), S(43, 43),
                                         S(43, 43), S(49, 49), S(55, 55), S(62, 62), S(66, 66), S(69, 69), S(73, 73), S(79, 79)};
